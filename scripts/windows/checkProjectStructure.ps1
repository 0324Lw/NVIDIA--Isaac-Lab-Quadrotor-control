...
Get-ChildItem -Recurse -Force | Where-Object { $_.FullName -notmatch '\.git|__pycache__|\.venv|\venv|\logs' } | ForEach-Object { Resolve-Path -Relative $_.FullName } | Sort-Object | Tee-Object -FilePath codeFrameworkTree.txt
