...
if (-not $CheckpointPath) {
  $Latest = Get-ChildItem -Path "logs/task2" -Recurse -Directory -Filter final_checkpoint -ErrorAction SilentlyContinue | Sort-Object FullName | Select-Object -Last 1
...
python -m quadrotor_rl.tasks.task2.task2_model_test --checkpoint $CheckpointPath --visualize @args
