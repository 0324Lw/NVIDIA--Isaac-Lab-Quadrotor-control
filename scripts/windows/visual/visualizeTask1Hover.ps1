...
if (-not $CheckpointPath) {
  $Latest = Get-ChildItem -Path "logs/task1" -Recurse -Directory -Filter final_checkpoint -ErrorAction SilentlyContinue | Sort-Object FullName | Select-Object -Last 1
...
python -m quadrotor_rl.tasks.task1.task1_model_test --checkpoint $CheckpointPath --visualize @args
