...
echo "============================================================"
echo "Quadrotor / Crazyflie Task3 Dynamic Obstacle Navigation Env Test"
...
python -m py_compile \
  ...
  src/quadrotor_rl/tasks/task3/task3_scene.py \
  src/quadrotor_rl/tasks/task3/task3_env.py \
