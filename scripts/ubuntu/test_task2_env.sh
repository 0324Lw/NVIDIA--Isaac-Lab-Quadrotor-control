...
echo "============================================================"
echo "Quadrotor / Crazyflie Task2 3D Trajectory Tracking Env Test"
...
python -m py_compile \
  src/quadrotor_rl/tasks/task2/task2_config.py \
  src/quadrotor_rl/tasks/task2/task2_scene.py \
  src/quadrotor_rl/tasks/task2/task2_env.py \
